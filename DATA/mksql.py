                ...
                if re.match(r"X\d{4}", raw):
                    ...
                    for i, row in enumerate(csvreader):
                        if re.match(r"X\d{4}", row[0]):
                            ...
                            raise Exception(
                                "OCS Inventory file issues, missing a serial #" + row[1]
                            )
                            ...
                            sim.append(
                                {
                                    ...
                                    "dt": next(
                                        (
                                            d["dt"]
                                            for d in con
                                            if d["serial"] == row[0] and d["type"] == t
                                        ),
                                        None,
                                    ),
                                }
                    ...
                    fcp.append(
                        {
                            ...
                            "loc": 6
                            if re.match(r"Do Not Deploy", row[2])
                            else 1
                            if re.match(r"Lab", row[3])
                            else 3
                            if re.match(r"Recovered", row[2])
                            else 7
                            if re.match(r"Deployed", row[2])
                            else 8,
